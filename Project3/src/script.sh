...
echo " "
sshpass -p $password ssh -o StrictHostKeyChecking=no -f $username@$registryHostName " rmiregistry -J-Djava.rmi.server.useCodebaseOnly=false 5000;" &
sleep 2
...
echo " "
sshpass -p $password ssh -o StrictHostKeyChecking=no -f $username@$GeneralRepositoryHostName " java monitors/GeneralRepository/GeneralRepositoryStart 22170 l040101-ws02.ua.pt 5000" &
sleep 5
echo " "
...
echo " "
sshpass -p $password ssh -o StrictHostKeyChecking=no -f $username@$ControlCenterHostName " java monitors/ControlCentre/ControlCentreStart 22174 l040101-ws03.ua.pt 5000" &
sleep 5
echo " "
...
echo " "
sshpass -p $password ssh -o StrictHostKeyChecking=no -f $username@$BettingCenterHostName " java monitors/BettingCentre/BettingCentreStart 22173 l040101-ws04.ua.pt 5000" &
sleep 5
echo " "
...
echo " "
sshpass -p $password ssh -o StrictHostKeyChecking=no -f $username@$RaceTrackHostName " java monitors/RacingTrack/RacingTrackStart 22175 l040101-ws05.ua.pt 5000" &
sleep 5
echo " "
...
echo "Setting Stable.... "
echo " "
sshpass -p $password ssh -o StrictHostKeyChecking=no -f $username@$StableHostName "java monitors/Stable/StableStart 22171 l040101-ws06.ua.pt 5000" &
sleep 5
echo " "
...
echo " "
sshpass -p $password ssh -o StrictHostKeyChecking=no -f $username@$PaddockHostName " java monitors/Paddock/PaddockStart 22172 l040101-ws06.ua.pt 5000" &
sleep 5
echo " "
...
echo "Setting Broker.... "
echo " "
sshpass -p $password ssh -o StrictHostKeyChecking=no -f $username@$BrokerHostName " java monitors/main/BrokerStart 22179 l040101-ws08.ua.pt 5000" &
sleep 5
echo " "

echo "Setting Horses.... "
echo " "
sshpass -p $password ssh -o StrictHostKeyChecking=no -f $username@$HorsesHostName " java monitors/main/HorseStart 22178 l040101-ws09.ua.pt 5000" &
sleep 5
echo " "

echo "Setting Spectator.... "
echo " "
sshpass -p $password ssh -o StrictHostKeyChecking=no -f $username@$SpectatorHostName " java monitors/main/SpectatorStart 22177 l040101-ws10.ua.pt 5000" &
sleep 5
echo " "
